...
MAPPING_2026_TSUJO = TemplateMapping(
    ...
    shinsei={
        ...
        'kurumin': 115,
        'business_types': 134,
        'officer_count_prev': 144,
        'management_intent': 157,
        'it_investment_status': 162,
        'it_utilization_status': 164,
        'security_status': 167,
        'future_goals': 171,
        'min_wage': 202,
        'wage_raise_declaration': 210,
        'wage_raise_amount': 211,
        'wage_raise_method': 212,
        'wage_raise_date': 213,
    },
