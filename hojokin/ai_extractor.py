...
2. **各従業員の月次給与を、`monthly` 配列に「1ヶ月=1要素」で入れてください。**
   要素の形: `{"ym": "YYYY-MM", "taxable": 整数, "hours": 数値 or null, "work_days": 数値 or null}`
...
[
  {
    ...
    "employment_type": "正社員",
    "monthly": [
      {"ym": "2024-08", "taxable": 335000, "hours": null, "work_days": 20},
      {"ym": "2024-09", "taxable": 333000, "hours": null, "work_days": 21}
    ],
    "bonuses": [
