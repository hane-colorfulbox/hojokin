...
_HANDOFF_CONTEXT_VERSION = '2026-07-26'
...
with st.expander(
    ...
    st.info(
        ...
        '`wagebook-convert`＝賃金台帳PDF変換（出力に原本転記シート群＝PDF全ページ・全項目の転記付き）／'
...
with st.expander(
    ...
    st.warning(
        ...
        '会社名・症状（例：給与支給総額が想定と合わない／人数が多すぎる 等）・CC が出力した Excel を添えてください。'
    )
...
# ── フッター ──
st.markdown('---')
st.caption(f'補助金書類自動作成ツール v0.2.92 | カラフルボックス株式会社')
